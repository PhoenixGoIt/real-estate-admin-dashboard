...
const Dashboard = () => {
  ...
  const latestSales = [
    { name: 'Metro Jayakar Apartment', price: '$535', location: 'North Carolina, USA', image: '/images/property1.jpg' },
    { name: 'Leto Ji Hotel & Apartment', price: '$460', location: 'Carolina Sun, UK', image: '/images/property2.jpg' },
    { name: 'Star Sun Hotel & Apartment', price: '$500', location: 'North Carolina, USA', image: '/images/property3.jpg' },
  ];
    ...
    <div className="min-h-screen bg-gray-950 text-white p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          />
          <span className="text-sm text-gray-400">Hawkins Maru - Company Manager</span>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        {stats.map((stat, index) => (
          <StatsCard key={index} title={stat.title} value={stat.value} color={stat.color} />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-gray-900 p-4 rounded-lg shadow-md">
          ...
          <p className="text-sm text-gray-400">Last Month: $217,000 | Running Month: $236,535 (0.8%)</p>
        </div>
        ...
        <div className="bg-gray-900 p-4 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {latestSales.map((sale, index) => (
              <PropertyCard key={index} {...sale} icon="/images/property-icon.png" />
            ))}
          </div>
        </div>
