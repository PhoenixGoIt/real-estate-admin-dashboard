...
const Search: React.FC<SearchItem> = ({ title, className, onChange }) => {
  ...
  return (
    <div
      className={`w-full relative flex-grow ${isSearchOpen ? "block" : "hidden"} lg:block`}
    >
      ...
      <input
        ...
        className={cn(
          ...
          className === "default" &&
            "pl-10 pr-4 py-2 rounded-lg outline-none bg-gray-100 transition-all hover:ring-2 hover:ring-blue-500",
        )}
      />
