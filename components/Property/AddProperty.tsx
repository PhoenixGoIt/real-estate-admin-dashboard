...
const AddProperty = () => {  
  ...
  return (
    <div className='ml-auto mr-auto w-[55%] h-full'>
      <h1 className='text-xl font-[700] text-primary_color mb-6'>Create Property</h1>   
            ...
            <form className='flex'>
                <div className='mb-6 w-full ml-6' >
                    ...
                    <div className='flex mt-6 gap-6'>
                      <div>
                        <div className='mb-3'><label className='text-md font-[500]'>Square<span className='text-red-600'>*</span></label></div>
                        <Input title='Square'/>
                      </div>
                     <div>
                        <div className='mb-3'><label className='text-md font-[500]'>AmountBed<span className='text-red-600'>*</span></label></div>
                    ...
                    <div className='mt-8'>
                      <div className='mb-3'><label className='text-lg font-[500]'>Facility:</label></div>
                      <Facility />
                    </div>
