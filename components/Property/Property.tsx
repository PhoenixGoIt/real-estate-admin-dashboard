      ...
      <div className='w-full h-full'>
        <div className='flex items-center mb-6  '>
          ...
          <Link href='/property-list/add-property' className='ml-auto'>
            <ButtonShared title='+ Add Property' />
          </Link>
        </div>
        <div className='bg-white w-full max-h-max rounded-lg p-5 mb-9'>
          <div>
            <ul className='flex gap-5 w-full mb-5'>
              <li className='w-full'>
                <Search
                  title='Enter an address, city or Zip code'
              ...
              <li>
                <button className='w-[80px] flex items-center px-3 py-2 bg-gray-100 border border-gray-300 rounded-md text-sm text-gray-700 hover:bg-gray-200 transition-colors duration-200'>
                  <Image
                    src='/more.svg'
                    alt='More'
                    width={16}
