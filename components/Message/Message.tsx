...
const mockMessages: IMessage[] = [
    {
        ...
        content: "Hi! I'm interested in the property at 123 Main Street. Is it still available?",
    ...
    },
    {
        ...
        senderId: "user2",
        receiverId: "current-user",
        content: "Hello, I saw your listing for the apartment downtown. Do you have any similar properties?",
...
const Message = () => {
    ...
    const handleChatSelect = (chat: IChat) => {
        ...
        const chatMessages = mockMessages.filter(
            msg => (msg.senderId === chat.participants[0].id && msg.receiverId === mockCurrentUser.id) ||
                   (msg.senderId === mockCurrentUser.id && msg.receiverId === chat.participants[0].id)
        );
                        ...
                        return (
                            <div 
                                ...
                                className={`p-3 flex items-center h-[75px] rounded-lg transition-all duration-200 mb-2 cursor-pointer
                                    ${isSelected ? 'bg-primary_color text-white' : 'hover:bg-primary_color hover:text-white'}`}
                            >
                                ...
                                <div className='ml-3'>
                                    <div className='text-md mb-1 font-medium'>{otherParticipant?.name}</div>
